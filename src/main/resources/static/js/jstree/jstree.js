//***********NOTE****************
//CODE HAS BEEN CHANGED TO OPEN/CLOSE ON SINGLE CLICKS RATHER THAN DOUBLE CLICKS
//  !!!!!!!!!!!!  ALTERED LINE 2350 TO IDENTIFY LEAF BRANCHES BY THE BEGINNING LETTER OF THEIR ID
/*!
 * jsTree {{VERSION}}
 * http://jstree.com/
 *
...
(function (factory) {
    ...
    $.jstree.core.prototype = {
        ...
        bind : function () {
            ...
            this.element
                ...
                .on("click.jstree", ".jstree-anchor", $.proxy(function (e) {
                    if(this.settings.core.click_toggle) {
                        this.toggle_node(e.target);
                    }
                }, this))
                .on("click.jstree", ".jstree-anchor", $.proxy(function (e) {
        ...
        redraw_node : function (node, deep, is_callback, force_render) {
            ...
            //console.log(obj);
            if(obj.state.loaded && !obj.children.length && obj.id.charAt(0)!="c") {
                c += ' jstree-leaf';
            }
            else {
